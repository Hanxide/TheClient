 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://service.han.com/", wsdlLocation = "http://172.16.11.207:9901/Service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://service.han.com/", "ServiceHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.16.11.207:9901/Service/ServiceHello?wsdl");
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://service.han.com/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.han.com/", "ServiceHelloPort"), ServiceHello.class, features);
    }
